    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 dark:bg-gray-900">
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-2xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                @endif --}}
                {{-- @include('error') --}}
                <form class="space-y-4 md:space-y-6" action="/address/{{$address->id}}" method="post">
                    @method('PATCH')
                    @csrf
                    <div class="flex items-center gap-x-4">
                        <div class="sm:col-span-2 flex-1">
                            <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
                            <input type="text" name="title" value="{{$address->title}}" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="work address, home address, etc...." required="">
                            @error('title')
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" value="{{$address->phone}}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" max="10" placeholder="e.g, 9331234567" required="">
                        @error('phone')
                        <span class="text-red-400">
                            {{$message}}
                        </span>
                    ...
                    <div>
                        ...
                        <textarea id="address" rows="4" name="address_line_1" value="{{$address->address_line_1}}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your address...">{{$address->address_line_1}}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="town_id" id="town_id" value="{{$address->town_id}}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" max="10" placeholder="e.g, 1, 2, 3..." required="">
                        @error('town_id')
                        <span class="text-red-400">
                            {{$message}}
                        </span>
                    ...
                    <div>
                        ...
                        <input type="text" name="user_id" id="user_id" value="{{$address->user_id}}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" max="10" placeholder="e.g, 1, 2, 3..." required="">
                        @error('user_id')
                        <span class="text-red-400">
                            {{$message}}
                        </span>
